 ...
 *
 * Usage:
 * - Success: ApiResponse.success(data, "Operation successful")
 * - Error: ApiResponse.error("Error message", 400)
 * - Validation: ApiResponse.validationError(errors)
 */
@Data
@Builder
@NoArgsConstructor
